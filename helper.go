...
// Memberikan status 201 dan header Location[cite: 1]
...
func noContent(c *fiber.Ctx) error {
	return c.SendStatus(fiber.StatusNoContent) // 204: berhasil, tanpa body[cite: 1]
}
...
// ngebaca string dari nilai query parameter dan ngubahnya ke int. kalo ga valid bakal return false
